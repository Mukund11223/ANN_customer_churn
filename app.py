...
# User input
geography = st.selectbox('Geography', One_geo_encoder.categories_[0])
...
# Use the correct feature names from the encoder
geo_encoded_df = pd.DataFrame(geo_encoded, columns=One_geo_encoder.get_feature_names_out(One_geo_encoder.feature_names_in_))
